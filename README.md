...
> **R:** Es mayor ya que al incluir los headers se trae todo su contenido al código, y se reemplaza la palabra de la macro por el valor
...
> **R:** No devuelve nada porque la frase no existe en el archivo, ya que el preprocesador elimina todos los comentarios del código fuente original al generar el archivo .i.
...
> **R:** Estas líneas le dicen al compilador exactamente en qué número de línea y en qué archivo original se encontraba el código que sigue a continuación. Proviene de stdio.h
...
> **R:** Estas instrucciones preparan la estructura de la memoria para la función.
...
> **R:** Ya que en matematica.o está definido
...
> **R:** Me da la opción de abrirlo con otros programas, como el bloc de notas
...
> **R:** Porque el programa utiliza funciones de bibliotecas externas compartidas. Los resuelve el Loader del Sistema Operativo, en el tiempo de ejecución.
